...
class SitkVtkTransformer:
    ...
    def __init__(self, sitk_image=None, three_by_three=None, translation=None, center=None):
        """
        ...
        if sitk_image is not None:
            self.transform_array = create_4x4_from_3x3(
                sitk_image.GetDirection(), translation=sitk_image.GetOrigin()
            )
    ...
    def apply_transform_to_mesh(self, mesh):
        """
    ...
    try:
        ...
        try:
            ...
            if composite.GetNumberOfTransforms() == 1:
                ...
                raise Exception(
                    "There is {} transforms in the composite transform, excpected 1!".format(
                        composite.GetNumberOfTransforms()
                    )
                )
