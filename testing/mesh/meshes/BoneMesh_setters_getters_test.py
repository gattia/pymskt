...
def test_set_list_cartilage_labels(
    list_cartilage_labels=[1, 2, 3, 4]
):
    mesh = mskt.mesh.BoneMesh()
...
def test_set_list_cartilage_list_exception_str_type_in_list(
    list_cartilage_labels=['1', '2', '3']
):
    mesh = mskt.mesh.BoneMesh()
    with pytest.raises(TypeError):
...
def test_get_list_cartilage_labels(
    list_cartilage_labels=[1, 2, 3, 4]
):
