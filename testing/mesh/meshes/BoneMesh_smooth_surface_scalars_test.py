...
REF_1_MESH = mskt.mesh.io.read_vtk('data/femur_thickness_mm_regions_10k_pts_thick_smoothed_1.25_sigma.vtk')
REF_3_MESH = mskt.mesh.io.read_vtk('data/femur_thickness_mm_regions_10k_pts_thick_smoothed_3_sigma.vtk')
